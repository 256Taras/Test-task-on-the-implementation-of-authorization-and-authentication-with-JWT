import { FastifyReply, DoneFuncWithErrOrRes, FastifyRequest } from 'fastify';

import { type FastifyJwtVerifyOptions, type VerifyOptions } from '@fastify/jwt';
...
declare module 'fastify' {
  interface FastifyInstance extends IJwtHandlers {
    verifyJwt: (req: FastifyRequest, res: FastifyReply, done: DoneFuncWithErrOrRes) => void;
  }
